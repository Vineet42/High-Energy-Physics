...
float m = 0;
m = 1/delta*(s1_err2*sxy_err2-sx_err2*sy_err2); //slope
...
float radiusActual = momentum/(0.3 * charge * field);
...
//else fill pm
if (plotReciprocals == 1){histo1->Fill(1/pm);}
else {histo1->Fill(pm);}
